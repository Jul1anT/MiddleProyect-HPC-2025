...
set output 'data/percolation_plot.png'
...
# Plot the data
plot 'data/probability_study.txt' using 1:2 with linespoints \
...
set output 'data/matrix_plot.png'
...
if (system("test -f data/matrix_data.txt") == 0) {
    plot "data/matrix_data.txt" using 2:1:3 with image title "Cluster IDs"
}